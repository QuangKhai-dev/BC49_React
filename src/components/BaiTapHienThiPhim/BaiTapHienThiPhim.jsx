...
export default class BaiTapHienThiPhim extends Component {
  ...
  // vận dụng lại hàm map để render lên giao diện các bộ phim đang có, cấu trúc các item phim giống với item đang làm mẫu
        ...
        <div className="row">
          {this.arrPhim.map((item, index) => {
            return (
              <div
                key={index}
                className="col-2 text-center text-white bg-success"
              >
          ...
          {/* <div className="col-2 text-center text-white bg-success">
            <img src={this.arrPhim[0].hinhAnh} alt="" />
            <h3>{this.arrPhim[0].tenPhim}</h3>
            <p>{this.arrPhim[0].ngayKhoiChieu}</p>
          </div> */}
        </div>
      </div>
    );
